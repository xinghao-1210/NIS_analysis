function varargout = hist2d_gui_autoname(varargin)
...
% Last Modified by GUIDE v2.5 20-Apr-2018 21:27:48
...
% handles    structure with handles and user data (see GUIDATA)
try
    [dump1,dump2,dump3,file,temppath]=read_NIS_objdata_autoname;
    handles.curdir=temppath;
    guidata(hObject,handles);
    cd(handles.curdir)
