 ...
 */
FARPROC WINAPI hist2d_gui_v2_1DelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = hist2d_gui_v2_1DelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = hist2d_gui_v2_1DelayLoadWin32FailureHook;
#endif
