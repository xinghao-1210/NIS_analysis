    ...
    B. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_hist2d_gui_v2.sh 
...
3. Collect the following files, based on what you are deploying: 
    ...
    NOTE: hist2d_gui_v2.ctf will be present only if you have chosen 
    ...
    All Platforms:
        * hist2d_gui_v2.ctf (if present)(Component Technology File archive,
          platform-dependent on target machine)

    Windows:
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          installer)
        * hist2d_gui_v2.exe (application created by MATLAB Compiler)

    UNIX:
        * MCRInstaller.bin (MATLAB Compiler Runtime installer)
        * hist2d_gui_v2 (application created by MATLAB Compiler)
        * run_hist2d_gui_v2.sh (shell script that can be run to 
    ...
    All Platforms:
        ...
        * hist2d_gui_v2.dll (shared library, file extension varies by 
          platform)
        * hist2d_gui_v2.h (library header file)
    ...
    Windows:
        * hist2d_gui_v2.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)    
        * hist2d_gui_v2.xml (documentation files)
        * hist2d_gui_v2.pdb (program database file - if DEBUG option 
          selected)
        * hist2d_gui_v2.dll (component assembly file)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
    ...
    Windows:
        * hist2d_gui_v2.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)
        * hist2d_gui_v2_1_0.dll (COM component)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)      
    ...
    All Platforms: 
        * hist2d_gui_v2.jar (Java class files and compiled M-code)
    ...
    Windows:
        * hist2d_gui_v2.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)
        * hist2d_gui_v2_1_0.dll (COM component)
        * hist2d_gui_v2.xla (optionally created and placed in
          D:\Stephen\Programming\matlab\NIS_analysis\hist2d_gui_v2\src directory by the user)  
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
